    ...
    public class NotificationManager : MonoBehaviour
    {
        ...
        public void Initialize(bool cancelPendingNotifications)
        {
                ...
                if (cancelPendingNotifications)
                {
                    ...
                    if (NotificationsManager.Instance.isDebug) Debug.LogError("AND: All Notifications Cancelled : Initialized");
                }
            #endif
            #if EnableNotificationsIos
                if (cancelPendingNotifications)
                {
                    ...
                    if (NotificationsManager.Instance.isDebug) Debug.LogError("IOS: All Notifications Cancelled : Initialized");
                }
            #endif
        }
        ...
        internal void SendNotificationOnId(int id, string title, string text, TimeSpan timeDelayFromNow, string smallIcon, string largeIcon, string customData, TimeSpan? repeatInterval)
        {
            #if EnableNotificationsAndroid
                var notification = new AndroidNotification();
                notification.Title = title;
