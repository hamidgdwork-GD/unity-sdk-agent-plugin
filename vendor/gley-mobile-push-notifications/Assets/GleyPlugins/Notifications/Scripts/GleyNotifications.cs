...
public static class GleyNotifications
{
    ...
    public static void SendNotificationOnId(int id, string title, string text, int hours, int minutes, int seconds, string smallIcon = null, string largeIcon = null, string customData = "")
    {
        NotificationManager.Instance.SendNotificationOnId(id, title, text, new System.TimeSpan(hours, minutes, seconds), smallIcon, largeIcon, customData, null);
    }
